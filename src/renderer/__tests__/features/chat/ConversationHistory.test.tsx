...
const sampleHistory = [
  { id: 'msg-1', role: 'user' as const, content: 'What blocks were found?', timestamp: Date.now() - 60000 },
  { id: 'msg-2', role: 'assistant' as const, content: '12 blocks were extracted.', timestamp: Date.now() - 55000 },
];
...
describe('SA-803 – Conversation History', () => {
  ...
  it('TC-01: sending a message persists it to local storage via storeSet', async () => {
    ...
    store.addMessage(ANALYSIS_ID, { id: 'msg-1', role: 'user', content: 'Hello', timestamp: Date.now() });
