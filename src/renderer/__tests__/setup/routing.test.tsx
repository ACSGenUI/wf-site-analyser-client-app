...
describe('TC-01: All routes render placeholder content', () => {
  ...
  it('renders Analysis Setup page at /analysis/new', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId('analysis-setup-page')).toBeInTheDocument(),
    );
  });
  ...
  it('renders Analysis Progress page at /analysis/:id/progress', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId('analysis-progress-page')).toBeInTheDocument(),
    );
  });
  ...
  it('renders Results Workspace at /projects/:projectId/results/:analysisId', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId('results-workspace-page')).toBeInTheDocument(),
    );
  });
  ...
  it('renders Force Update page at /force-update', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId('force-update-page')).toBeInTheDocument(),
    );
  });
});
